...
int main() {
    ...
    {
        MICROPROFILE_SCOPEI("group","ht_build", MP_YELLOW);
         //build table
    ...
    Table table_probe(1,16 * 1024*1024*32);
    ...
    {
        MICROPROFILE_SCOPEI("group","bf_build", MP_BLUE);
    ...
    MicroProfileDumpFileImmediately("test.html", "test.csv", nullptr);
